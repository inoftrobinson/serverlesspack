...
export default class BarChart extends React.Component<NetworkDirectedGraphProps, NetworkDirectedGraphState> {
    ...
    ticked() {
        if (this.linkPath !== undefined && this.linkLabel !== undefined && this.nodeCircle !== undefined && this.nodeLabel !== undefined) {
            this.linkPath
    ...
    dragended(d) {
        // d3.event = require("d3-selection").event;
        if (!d.active) {
